...
const Route2 = loadable$2(() => __vitePreload(() => import("./a.c0d8280d.js"), true ? [] : void 0));
...
const Route5 = loadable$2(() => __vitePreload(() => import("./index.46d06b19.js"), true ? [] : void 0));
const Route6 = loadable$2(() => __vitePreload(() => import("./index.78c055e4.js"), true ? [] : void 0));
[
  ...
  { path: "/guide/a", element: React.createElement(Route2), preload: () => __vitePreload(() => import("./a.c0d8280d.js"), true ? [] : void 0) },
  ...
  { path: "/guide/", element: React.createElement(Route5), preload: () => __vitePreload(() => import("./index.46d06b19.js"), true ? [] : void 0) },
  { path: "/", element: React.createElement(Route6), preload: () => __vitePreload(() => import("./index.78c055e4.js"), true ? [] : void 0) }
];
createContext({});
const link$2 = "_link_e8189_1";
const socialLinkIcon = "_social-link-icon_e8189_12";
const nav = "_nav_e8189_22";
const styles$8 = {
  link: link$2,
  socialLinkIcon,
  nav
};
const check = "_check_1qqyy_17";
const icon = "_icon_1qqyy_34";
const dark = "_dark_1qqyy_29";
const sun = "_sun_1qqyy_57";
const moon = "_moon_1qqyy_61";
const styles$7 = {
  "switch": "_switch_1qqyy_1",
  check,
  icon,
  dark,
  sun,
...
const doc = "";
const __uno = "";
const clip = "_clip_c40xt_1";
const styles$6 = {
  clip
};
const link$1 = "_link_hj6wu_1";
const styles$5 = {
  link: link$1
};
const button = "_button_s6ofo_1";
const medium = "_medium_s6ofo_14";
const big = "_big_s6ofo_21";
const brand = "_brand_s6ofo_28";
const alt = "_alt_s6ofo_47";
const styles$4 = {
  button,
  medium,
  big,
...
const sidebar = "_sidebar_7y4kx_1";
const styles$3 = {
  sidebar
};
const link = "_link_hj6wu_1";
const styles$2 = {
  link
};
const content = "_content_nfd8q_1";
const docContent = "_doc-content_nfd8q_14";
const asideContainer = "_aside-container_nfd8q_21";
const styles$1 = {
  content,
  docContent,
  asideContainer
};
const prev = "_prev_uyetz_1";
const next = "_next_uyetz_2";
const pagerLink = "_pager-link_uyetz_6";
const title = "_title_uyetz_20";
const desc = "_desc_uyetz_29";
const styles = {
  prev,
  next,
  pagerLink,
